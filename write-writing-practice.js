...
fs.mkdirSync('app/api/writing-practice', { recursive: true })
fs.writeFileSync('app/api/writing-practice/route.ts', apiRoute, 'utf8')
console.log('API:', fs.statSync('app/api/writing-practice/route.ts').size)
