...
// 1. VideoPlayerContext
const ctx = `"use client"
...
// 2. MiniVideoPlayer component
const mini = `"use client"
...
fs.writeFileSync('contexts/VideoPlayerContext.tsx', ctx, 'utf8')
fs.writeFileSync('components/MiniVideoPlayer.tsx', mini, 'utf8')
console.log('Context:', fs.statSync('contexts/VideoPlayerContext.tsx').size, 'bytes')
console.log('MiniPlayer:', fs.statSync('components/MiniVideoPlayer.tsx').size, 'bytes')
