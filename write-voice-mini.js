...
fs.writeFileSync('contexts/VoiceChatContext.tsx', ctx, 'utf8')
fs.writeFileSync('components/MiniVoicePlayer.tsx', mini, 'utf8')
console.log('VoiceChatContext:', fs.statSync('contexts/VoiceChatContext.tsx').size)
console.log('MiniVoicePlayer:', fs.statSync('components/MiniVoicePlayer.tsx').size)
