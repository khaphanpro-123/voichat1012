...
fs.mkdirSync('app/dashboard-new/writing-practice', { recursive: true })
fs.writeFileSync('app/dashboard-new/writing-practice/page.tsx', page, 'utf8')
console.log('Page:', fs.statSync('app/dashboard-new/writing-practice/page.tsx').size)
