...
- [ ] 1. Set up infrastructure connections and configuration
...
- [ ] 2. Implement Upload API core functionality
  - [ ] 2.1 Create file upload endpoint with multipart form handling
  ...
  - [ ] 2.2 Implement R2 storage upload with retry logic
